      ...
      mask: function (n, o) {
        ...
        return (
          ...
          this.trigger("unmask").each(function () {
            function d() {
              if (o.completed) {
                for (var e = f; e <= s; e++) if (l[e] && S[e] === g(e)) return;
                o.completed.call(R);
              }
            }
            function g(e) {
            ...
            function j(e) {
              ...
              return (
                e
                  ? x()
                  : r + 1 < u
                  ? o.autoclear || S.join("") === A
                    ? (R.val() && R.val(""), y(0, h))
                    : x()
                  : (x(), R.val(R.val().substring(0, r + 1))),
                u ? t : f
              );
            }
            var R = e(this),
                  ...
                  if (!R.prop("readonly")) {
                    ...
                    (m = R.val()),
                      8 === r || 46 === r || (a && 127 === r)
                        ...
                        ? b.call(this, e)
                        : 27 === r &&
                          (R.val(T), R.caret(0, j()), e.preventDefault());
                  }
                })
                .on("keypress.mask", function (t) {
                  if (!R.prop("readonly")) {
                    ...
                    if (
                      ...
                      if (
                        (c.end - c.begin != 0 &&
                          (y(c.begin, c.end), v(c.begin, c.end - 1)),
                        (n = p(c.begin - 1)) < h &&
